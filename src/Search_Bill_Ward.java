...
public class Search_Bill_Ward extends javax.swing.JFrame {

    public Search_Bill_Ward() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Bill Ward Details");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Bill_Ward().setVisible(true);
            }
        });
    }
