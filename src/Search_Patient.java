...
public class Search_Patient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Patient Details");
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 1240, 300));
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
            ...
            String sql = "select * from Patientregistration where PatientID= '" + txtPatientID.getText() + "' and PatientName ='" + txtPatientName.getText() + "'";
            ...
            if (rs.next()) {
                ...
                int s7 = Integer.parseInt(rs.getString("Age"));
                String s8 = rs.getString("Gen");
                String s9 = rs.getString("BG");
                String s10 = rs.getString("Remarks");
