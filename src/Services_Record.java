...
public class Services_Record extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Services Records");
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try {
            ...
            String sql = "select * from Services group by PatientID,PatientName having PatientID !=0 order by PatientID;";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "select * from Services where Services.PatientID ='" + table_click + "';";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            if (rs.next()) {
                this.hide();
                ...
                int add4 = rs.getInt("PatientID");
                String add5 = Integer.toString(add4);
                frm.txtPatientID.setText(add5);
