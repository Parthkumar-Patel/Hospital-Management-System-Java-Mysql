...
public class PatientDischarge_RoomRecord1 extends javax.swing.JFrame {

    public PatientDischarge_RoomRecord1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Patient Discharge Room Records");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "Gender", "Blood Group", "Disease", "Admit Date", "Room No.", "RoomCharges", "Doctor ID", "Doctor Name", "Discharged Date", "Remarks"
            }
        ) {
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try {
            ...
            String sql = "Select PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,Room.RoomNo,Room.RoomCharges,DoctorID,DoctorName,DischargeDate,DP_Remarks from DischargePatient_Room,Room where Room.RoomNo=DischargePatient_Room.RoomNo and PatientID != 0  order by PatientID";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "Select PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,Room.RoomNo,Room.RoomCharges,DoctorID,DoctorName,DischargeDate,DP_Remarks from DischargePatient_Room,Room where Room.RoomNo=DischargePatient_Room.RoomNo and PatientID='" + table_click + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            if (rs.next()) {
                this.hide();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientDischarge_RoomRecord1().setVisible(true);
            }
        });
    }
