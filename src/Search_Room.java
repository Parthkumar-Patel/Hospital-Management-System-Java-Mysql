...
public class Search_Room extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Room Details");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbRoomType, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtRoomNo, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
   ...
   try {
        ...
        if (cmbRoomType.getSelectedItem().equals("")) {
            ...
            String sql = "select * from Room where RoomNo= '" + txtRoomNo.getText() + "' and RoomType ='" + cmbRoomType.getSelectedItem() + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            if (rs.next()) {
                int s1 = Integer.parseInt(rs.getString("RoomNo"));
                String s2 = rs.getString("RoomType");
                int s3 = Integer.parseInt(rs.getString("RoomCharges"));
                String s4 = rs.getString("RoomStatus");
                model.addRow(new Object[]{s1, s2, s3, s4});
            } else {
                JOptionPane.showMessageDialog(this, "Room No. or Room Type does not match!", "Access denied", JOptionPane.ERROR_MESSAGE);
            }
            con.close();
            st.close();
            rs.close();
