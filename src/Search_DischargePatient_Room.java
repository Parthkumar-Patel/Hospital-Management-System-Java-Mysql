...
public class Search_DischargePatient_Room extends javax.swing.JFrame {

    public Search_DischargePatient_Room() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(Back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 670, 160, 50));
        ...
        jPanel4.add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 670, 180, 50));
        ...
        jLabel4.setText("Search Patient Discharge Room Details");
        ...
        jPanel4.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "Gender", "Blood Group", "Disease", "Admit Date", "Room No.", "Doctor ID", "Doctor Name", "Discharged Date", "Remarks"
            }
        ) {
        ...
        jPanel4.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 1240, 230));
        ...
        jPanel4.add(Del, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 670, 160, 50));

        ADD.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ADD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Save.png"))); // NOI18N
        ADD.setText("Save");
        ADD.setEnabled(false);
        jPanel4.add(ADD, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 670, 160, 50));
        ...
        jPanel4.add(New, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 670, 160, 50));
        ...
        jPanel4.add(Refresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 670, 160, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background.png"))); // NOI18N
        jLabel1.setOpaque(true);
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1370, 660));

        jLabel2.setBackground(new java.awt.Color(211, 219, 238));
        jLabel2.setOpaque(true);
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 660, 1390, 64));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 1359, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
            ...
            String sql = "select * from DischargePatient_Room where PatientID= '" + PatientID.getText() + "' and PatientName ='" + txtPatientName.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_DischargePatient_Room().setVisible(true);
            }
        });
    }
