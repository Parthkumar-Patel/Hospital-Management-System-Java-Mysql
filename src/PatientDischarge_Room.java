...
public void fillcombo()
{
 ...
 public void get(){
     try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "Select * from AdmitPatient_Room where PatientID != 0  order by PatientID";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Patient Discharge Room Details");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "Gender", "Blood Group", "Disease", "Admit Date", "Roon No.", "Doctor ID", "Doctor Name", "Remarks"
            }
        ) {
        ...
        cmbRoomNo.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        cmbRoomNo.setForeground(new java.awt.Color(51, 153, 0));
        jPanel1.add(cmbRoomNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 225, -1));
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        PatientDischarge_RoomRecord frm = new PatientDischarge_RoomRecord();
        frm.setVisible(true);
        this.dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "Select * from AdmitPatient_Room where  PatientID='" + table_click + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            if (rs.next()) {
                ...
                cmbRoomNo.setSelectedItem(add14);
    ...
    private void UpdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdActionPerformed
        try {
            ...
            String sql1 = "update DischargePatient_Room set PatientID='" + PatientID.getText() + "',PatientName='" + txtPatientName.getText() + "',Gender='" + txtGender.getText() + "',BloodGroup='" + txtBloodGroup.getText() + "',Disease='" + txtDisease.getText() + "',AdmitDate='" + txtAdmitDate.getText() + "',RoomNo=" + cmbRoomNo.getSelectedItem() + ",DoctorID='" + txtDoctorID.getText() + "',DoctorName='" + txtDoctorName.getText() + "',DischargeDate='" + txtDischargeDate.getText() + "',DP_Remarks='" + txtRemarks.getText() + "' where PatientID= " + PatientID.getText() + "";
            int rowsEffected1 = stmt1.executeUpdate(sql1);
            /*Statement stmt2 = con.createStatement();
            String sql2 = " update DischargePatient_RoomMain set  PatientID='" + PatientID.getText() + "',PatientName='" + txtPatientName.getText() + "',Gen='" + txtGender.getText() + "',BG='" + txtBloodGroup.getText() + "',Disease='" + txtDisease.getText() + "',AdmitDate='" + txtAdmitDate.getText() + "',RoomNo=" + cmbRoomNo.getSelectedItem() + ",DoctorID='" + txtDoctorID.getText() + "',DoctorName='" + txtDoctorName.getText() + "',DischargeDate='" + txtDischargeDate.getText() + "',AP_Remarks='" + txtRemarks.getText() + "' where PatientID= '" + PatientID.getText() + "'";
            int rowsEffected2 = stmt2.executeUpdate(sql2);*/
            JOptionPane.showMessageDialog(this, "Data Successfully Updated", "Patient Discharge Room Record", JOptionPane.INFORMATION_MESSAGE);
            Reset();
            con.close();
            stmt1.close();
            //stmt2.close();
    ...
    private void DelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DelActionPerformed
        try {
            ...
            if (P == 0) {
                ...
                String sql = "delete from DischargePatient_Room where PatientID = " + PatientID.getText() + "";
                int rowsEffected = stmt.executeUpdate(sql);
                /*Statement stmt1 = con.createStatement();
                String sql1 = "delete from DischargePatient_RoomMain where PatientID = " + PatientID.getText() + "";
                int rowsEffected1 = stmt1.executeUpdate(sql1);*/
                JOptionPane.showMessageDialog(this, "Data Successfully Deleted", "Patient Discharge Room Record", JOptionPane.INFORMATION_MESSAGE);
                Reset();
                con.close();
                stmt.close();
               // stmt1.close();
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            Statement stmt = con.createStatement();
            String sql = "Select * from DischargePatient_Room where PatientID= '" + PatientID.getText() + "'";
            ...
            if (rs.next()) {
                ...
                /*Statement stmt2 = con.createStatement();
                String sql2 = "insert into DischargePatient_RoomMain(PatientID,PatientName,Gen,BG,Disease,AdmitDate,RoomNo,DoctorID,DoctorName,DischargeDate,AP_Remarks)values('" + PatientID.getText() + "','" + txtPatientName.getText() + "','" + txtGender.getText() + "','" + txtBloodGroup.getText() + "','" + txtDisease.getText() + "','" + txtAdmitDate.getText() + "'," + cmbRoomNo.getSelectedItem() + ",'" + txtDoctorID.getText() + "','" + txtDoctorName.getText() + "','" + txtDischargeDate.getText() + "','" + txtRemarks.getText() + "')";
                int rowsEffected2 = stmt2.executeUpdate(sql2);*/
                Statement stmt3 =con.createStatement();
                String sql3 = "insert into DischargePatient_Room(PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,RoomNo,DoctorID,DoctorName,DischargeDate,DP_Remarks)values('" + PatientID.getText() + "','" + txtPatientName.getText() + "','" + txtGender.getText() + "','" + txtBloodGroup.getText() + "','" + txtDisease.getText() + "','" + txtAdmitDate.getText() + "'," + cmbRoomNo.getSelectedItem() + ",'" + txtDoctorID.getText() + "','" + txtDoctorName.getText() + "','" + txtDischargeDate.getText() + "','" + txtRemarks.getText() + "')";
                int rowsEffected3 = stmt3.executeUpdate(sql3);
                Statement stmt4 = con.createStatement();
                String sql4 = "update room set RoomStatus='Vacant' where RoomNo='" + cmbRoomNo.getSelectedItem() + "'";
                int rowsEffected4 = stmt4.executeUpdate(sql4);
                //stmt2.close();
                stmt3.close();
                stmt4.close();
            }
            JOptionPane.showMessageDialog(this, "Data Successfully Saved", "Patient Discharge Room Record", JOptionPane.INFORMATION_MESSAGE);
            Reset();
            con.close();
            stmt.close();
            rs.close();
