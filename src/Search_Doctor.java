...
public class Search_Doctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Doctor Details");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor ID", "Doctor Name", "Father Name", "Address", "Contact No", "Email Id", "Qualifications", "Specialization", "Gender", "Blood Group", "Date Of Joining"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtDoctorID, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
   ...
   try {
       if (txtDoctorID.getText().equals("")) {
        ...
        if (txtDoctorName.getText().equals("")) {
            ...
            String sql = "select * from Doctor where DoctorID= '" + txtDoctorID.getText() + "' and DoctorName ='" + txtDoctorName.getText() + "'";
            ...
            if (rs.next()) {
                ...
                String s3 = rs.getString("FatherName");
                ...
                String s8 = rs.getString("Specialization");
                String s9 = rs.getString("Gender");
                String s10 = rs.getString("BloodGroup");
                String s11 = rs.getString("DateOfJoining");
                model.addRow(new Object[]{s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11});
            } else {
                JOptionPane.showMessageDialog(this, "Doctor Id or Doctor Name does not match!", "Access denied", JOptionPane.ERROR_MESSAGE);
            }
            con.close();
            st.close();
            rs.close();
