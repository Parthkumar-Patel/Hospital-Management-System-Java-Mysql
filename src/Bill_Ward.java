...
private void setdata()
{
    try{
            ...
            String sql= "select max(BillNo+1)as'BillNo' from Bill_Ward;";
...
{   
 ...
 private void Get_Data1(){
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Bill Ward Details");
        ...
        txtWardname.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        jLabel21.setText("Bed Charge");

        jLabel17.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 0, 255));
        jLabel17.setText("Total Bed Charges");

        txtBedCharges.setEditable(false);
        txtBedCharges.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        txtBedCharges.setForeground(new java.awt.Color(51, 153, 0));
        txtBedCharges.setEnabled(false);

        txtTotalBedCharges.setEditable(false);
        txtTotalBedCharges.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        txtTotalBedCharges.setForeground(new java.awt.Color(51, 153, 0));
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(59, 59, 59)
                                .addComponent(cmbPaymentMode, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(jLabel21)
                                .addGap(88, 88, 88)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtBedCharges)
                                    .addComponent(txtServiceCharges, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE))
                                .addGap(27, 27, 27)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(38, 38, 38)
                                .addComponent(txtTotalBedCharges, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(81, 81, 81))
        );
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel17)
                        .addComponent(txtTotalBedCharges, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel16)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel37)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        .addComponent(txtBedCharges, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        try {
            ...
            if (txtWardname.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Please Retrieve Ward Name", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (txtBedCharges.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Please Retrieve Bed Charges", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (txtTotalBedCharges.getText().equals("")) {
                JOptionPane.showMessageDialog( this, "Please Retrieve Total Bed Charges","Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            String sql="Select BillNo from Bill_Ward where BillNo=" + txtBillNo.getText() + "";
            ...
            if (rs.next()) {
                ...
                return;
                    ...
                    String sql3= "insert into Bill_Ward(BillNo,PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,WardName,DoctorID,DoctorName,DischargeDate,BedCharges,NoOfDays,TotalBedCharges,ServiceCharges,BillingDate,PaymentMode,PaymentModeDetails,TotalCharges,ChargesPaid,DueCharges) values ("+txtBillNo.getText()+","+ PatientID.getText() + ",'"+ txtPatientName.getText() + "','"+ txtGender.getText() + "','"+ txtBloodGroup.getText() + "','"+ txtDisease.getText() + "','"+ txtAdmitDate.getText() + "','"+ txtWardname.getText() + "',"+ txtDoctorID.getText() + ",'"+ txtDoctorName.getText() + "','"+ txtDischargeDate.getText() + "',"+ txtBedCharges.getText() + ","+ txtNoOfDays.getText() + "," + txtTotalBedCharges.getText() +","+ txtServiceCharges.getText() + ",'"+ txtBillingDate.getText() + "','" + cmbPaymentMode.getSelectedItem()+ "','" + txtPaymentModeDetails.getText() + "',"+ txtTotalPaid.getText() + ","+ txtTotalCharges.getText() +","+ txtDueCharges.getText() + ");";
                    int rowsEffected3 = stmt3.executeUpdate(sql3);
                    JOptionPane.showMessageDialog(this, "Data Successfully Saved", "Bill Ward Record", JOptionPane.INFORMATION_MESSAGE);
                    stmt3.close();
    ...
    private void DelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DelActionPerformed
        try {
            ...
            if (P == 0) {
                ...
                JOptionPane.showMessageDialog(this, "Data Successfully Deleted", "Bill Ward Record", JOptionPane.INFORMATION_MESSAGE);
                Reset();
                con.close();
                stmt.close();
    ...
    private void UpdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdActionPerformed
        try{
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            Statement st = con.createStatement();
            String sql= "update Bill_Ward set BillNo="+ txtBillNo.getText() + ",PatientID="+ PatientID.getText() + ",PatientName='"+ txtPatientName.getText() + "',Gender='"+ txtGender.getText() + "',BloodGroup='"+ txtBloodGroup.getText() + "',Disease='"+ txtDisease.getText() + "',AdmitDate='"+ txtAdmitDate.getText() + "',WardName='"+ txtWardname.getText() + "',DoctorID="+ txtDoctorID.getText() + ",DoctorName='"+ txtDoctorName.getText() + "',DischargeDate='"+ txtDischargeDate.getText() + "',BillingDate='"+ txtBillingDate.getText() + "',BedCharges="+ txtBedCharges.getText() + ",ServiceCharges="+ txtServiceCharges.getText() + ",PaymentMode='" + cmbPaymentMode.getSelectedItem()+ "',PaymentModeDetails='" + txtPaymentModeDetails.getText() + "',ChargesPaid="+ txtTotalPaid.getText() + ",DueCharges="+ txtDueCharges.getText() + ",TotalCharges="+ txtTotalCharges.getText() + ",NoOfDays="+ txtNoOfDays.getText() +",TotalBedCharges=" + txtTotalBedCharges.getText() + " where BillNo= " + txtBillNo.getText() +"";
            int rowsEffected = st.executeUpdate(sql);
            JOptionPane.showMessageDialog(this,"Data Successfully Updated","Bill Ward Record",JOptionPane.INFORMATION_MESSAGE);
            Reset();
        }catch(Exception ex){
            JOptionPane.showMessageDialog(this,ex);
        }
    ...
    private void btnNew2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNew2ActionPerformed
        this.dispose();
        PatientDischarge_WardRecord1 frm = new PatientDischarge_WardRecord1();
        frm.setVisible(true);
    ...
    public static javax.swing.JTextField txtBedCharges;
    ...
    public static javax.swing.JTextField txtTotalBedCharges;
    public static javax.swing.JTextField txtTotalCharges;
    public static javax.swing.JTextField txtTotalPaid;
    public static javax.swing.JTextField txtWardname;
