...
public class Search_DischargePatient_Ward extends javax.swing.JFrame {

    public Search_DischargePatient_Ward() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Patient Discharge Ward Details");
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
            ...
            String sql = "select * from DischargePatient_Ward where PatientID= '" + PatientID.getText() + "' and PatientName ='" + txtPatientName.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_DischargePatient_Ward().setVisible(true);
            }
        });
    }
