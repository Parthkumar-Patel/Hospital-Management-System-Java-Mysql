...
public class Bill_WardRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Bill Ward Records");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill No", "Patient Id", "Patient Name", "Gender", "Blood Group", "Disease", "Admit Date", "Ward Name", "Doctor Id", "Doctor Name", "Discharge Date", "Bed Charges", "NoOfDays", "TotalBedCharges", "Service Charges", "Billing Date", "Payment Mode", "Payment Mode Details", "Total Charges", "Charge Paid", "Due Charge"
            }
        ) {
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try {
            ...
            String sql = "select * from Bill_Ward where BillNo !=0 order by BillNo";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "select * from Bill_Ward where BillNo = '" + table_click + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            if (rs.next()) {
                this.hide();
                ...
                String add8=rs.getString("WardName");
                frm.txtWardname.setText(add8);
                ...
                String add12=rs.getString("BedCharges");
                frm.txtBedCharges.setText(add12);
                String add13=rs.getString("NoOfDays");
                frm.txtNoOfDays.setText(add13);
                String add14=rs.getString("TotalBedCharges");
                frm.txtTotalBedCharges.setText(add14);
