...
public class Search_Services extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Services Details");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtServiceName, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 1240, 270));
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
            ...
            String sql = "select * from Services where ServiceName= '" + txtServiceName.getText() + "' and PatientID ='" + txtPatientID.getText() + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            if (rs.next()) {
                String s1 = rs.getString("ServiceName");
                String s2 = rs.getString("ServiceDate");
                int s3 = Integer.parseInt(rs.getString("PatientID"));
                String s4 = rs.getString("PatientName");
                int s5 = Integer.parseInt(rs.getString("ServiceCharges"));
                model.addRow(new Object[]{s1, s2, s3, s4, s5});
            } else {
                JOptionPane.showMessageDialog(this, "Service Name or Patient Id does not match!", "Access denied", JOptionPane.ERROR_MESSAGE);
            }
            con.close();
            st.close();
            rs.close();
    ...
    private void NewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewActionPerformed
        ...
        txtServiceName.requestDefaultFocus();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Services().setVisible(true);
            }
        });
    }
