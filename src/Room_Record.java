...
public class Room_Record extends javax.swing.JFrame {
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try {
            ...
            String sql = "select * from Room where RoomNo != 0 order by RoomNo";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (rs.next()) {
                ...
                int add = rs.getInt("RoomNo");
                String add1 = Integer.toString(add);
                frm.txtRoomNo.setText(add1);
                String add2 = rs.getString("RoomType");
                frm.cmbRoomType.setSelectedItem(add2);
                int add3 = rs.getInt("RoomCharges");
                String add4 = Integer.toString(add3);
                frm.txtRoomCharges.setText(add4);
            }
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Room_Record().setVisible(true);
            }
        });
    }
