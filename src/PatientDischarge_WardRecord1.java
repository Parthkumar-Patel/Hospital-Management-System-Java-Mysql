...
public class PatientDischarge_WardRecord1 extends javax.swing.JFrame {

    public PatientDischarge_WardRecord1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "Gender", "Blood Group", "Disease", "Admit Date", "WardName", "Bed Charges", "Doctor ID", "Doctor Name", "Discharged Date", "Remarks"
            }
        ) {
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try {
            ...
            String sql = "Select PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,Ward.WardName,Ward.Charges,DoctorID,DoctorName,DischargeDate,DP_Remarks from DischargePatient_Ward,Ward where Ward.WardName=DischargePatient_Ward.WardName and PatientID != 0  order by PatientID";
            ...
            while (rs.next()) {
                ...
                int s8 = Integer.parseInt(rs.getString("Charges"));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS","root","mysql");
            String sql = "Select PatientID,PatientName,Gender,BloodGroup,Disease,AdmitDate,Ward.WardName,Ward.Charges,DoctorID,DoctorName,DischargeDate,DP_Remarks from DischargePatient_Ward,Ward where Ward.WardName=DischargePatient_Ward.WardName and PatientID='" + table_click + "'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            if (rs.next()) {
                this.hide();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientDischarge_WardRecord1().setVisible(true);
            }
        });
    }
