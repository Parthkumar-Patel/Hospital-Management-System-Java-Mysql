...
public class Search_PatientAdmit_Ward extends javax.swing.JFrame {

    public Search_PatientAdmit_Ward() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search Patient Admit Ward Details");
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 1240, 340));
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try {
            ...
            String sql = "select * from AdmitPatient_Ward where PatientID= '" + PatientID.getText() + "' and PatientName ='" + txtPatientName.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_PatientAdmit_Ward().setVisible(true);
            }
        });
    }
