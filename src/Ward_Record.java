...
public class Ward_Record extends javax.swing.JFrame {
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try{
            ...
            String sql="select * from Ward where WardName !='Ward name' order by Wardname";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            DefaultTableModel model=(DefaultTableModel) jTable1.getModel();
            while(rs.next())
            {
                String s1=rs.getString("Wardname");
                String s2=rs.getString("wardType");
                int s3=Integer.parseInt(rs.getString("NoOfBeds"));
                int s4=Integer.parseInt(rs.getString("Charges"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ward_Record().setVisible(true);
            }
        });
    }
